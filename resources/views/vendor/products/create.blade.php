                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                             ...
                             <div>
                                ...
                                <x-text-input id="stock_quantity" name="stock_quantity" type="number" class="mt-1 block w-full" :value="old('stock_quantity')" required />
                             ...
                             <div class="md:col-span-2">
                                 <div class="flex items-center mt-4">
                                     <input id="is_available" name="is_available" type="checkbox" value="1" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" {{ old('is_available', true) ? 'checked' : '' }}>
